...
import com.example.outpatientsys.controller.exception.ValidCodeNotMatchException;
import com.example.outpatientsys.service.exception.InsertException;
import com.example.outpatientsys.service.exception.ServiceException;
...
public class BaseController {
     ...
     **/
    @ExceptionHandler({ServiceException.class, ValidCodeNotMatchException.class}) //统一处理抛出的异常
